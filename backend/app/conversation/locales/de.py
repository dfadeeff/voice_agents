...
PHASE_PROMPTS: dict[CallPhase, str] = {
    ...
    CallPhase.ROUTING: (
        ...
        "- Bestätige kurz, was du verstanden hast, bevor du routest.\n"
        "- Wenn der Anrufer eine Person sprechen möchte, rufe sofort request_handoff auf.\n"
    ...
    CallPhase.ESCALATION: (
        "Das Anliegen des Anrufers wird an ein Teammitglied weitergegeben. "
        "Sage: 'Ich kann Ihr Anliegen an ein Teammitglied weitergeben. "
        "Ich habe die bisherigen Informationen für den Rückruf notiert.' "
        "Sei ehrlich — tu nicht so, als würdest du live verbinden."
    ),
}
...
SYSTEM_PROMPT_LOCAL = (
    ...
    "6. Wenn der Anrufer eine Person sprechen möchte, biete an, sein Anliegen weiterzuleiten.\n\n"
    "REGELN:\n"
    "- Sprich AUSSCHLIESSLICH Deutsch. Kein Englisch, kein Chinesisch.\n"
